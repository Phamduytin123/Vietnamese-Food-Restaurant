export const IMAGES = {
    ...
    icon_donut: require('../assets/images/icon-donut.png'),
    icon_invoice: require('../assets/images/icon-invoice.png'),
    icon_location: require('../assets/images/icon-location.png'),
    icon_noti: require('../assets/images/icon-noti.png'),
    ...
    icon_feature1: require('../assets/images/icon-feature1.png'),
    icon_feature2: require('../assets/images/icon-feature2.png'),
    icon_feature3: require('../assets/images/icon-feature3.png'),
