...
export class CreateItemReq {
    ...
    @IsNotEmpty({
        message: i18nValidationMessage(
            'validation.item.description_vi_required'
        ),
    })
    ...
    @IsNotEmpty({
        message: i18nValidationMessage(
            'validation.item.description_en_required'
        ),
    })
    ...
    @IsNotEmpty({
        message: i18nValidationMessage(
            'validation.item.ingredients_vi_required'
        ),
    })
    ...
    @IsNotEmpty({
        message: i18nValidationMessage(
            'validation.item.ingredients_en_required'
        ),
    })
