...
export class AccountService {
    ...
    async updateAccount(lang: string, currentAccount: Account, updateAccount: AccountUpdateDto) {
        ...
        accountFound.displayName = updateAccount.displayName ?? accountFound.displayName;
        ...
        if (!PasswordUtils.checkPassword(updateAccount.password, accountFound.password)) {
            accountFound.password = PasswordUtils.hashPassword(updateAccount.password)
        }
