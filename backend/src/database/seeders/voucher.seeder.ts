...
const vouchers = [
  {
    name_vi: 'Tri ân khách hàng',
    name_en: 'Customer appreciation',
    code: 'TRIANKHACHHANG',
    discount: 15,
    minPrice: 200,
  ...
  },
  {
    ...
    name_en: 'Weekend shopping offer',
    code: 'WEEKENDSALE',
    discount: 15,
    minPrice: 100,
  ...
  },
  {
    ...
    name_en: 'National Day promotion',
    code: 'NATIONALDAY',
    discount: 35,
    minPrice: 220,
