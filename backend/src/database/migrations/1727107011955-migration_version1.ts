...
export class Version11727107011955 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`totalPrice\` int NOT NULL, \`phoneNumber\` varchar(10) NOT NULL, \`receiver\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`paymentMethod\` varchar(255) NOT NULL DEFAULT 'cash', \`status\` varchar(255) NOT NULL DEFAULT 'wait', \`reasonCancel\` varchar(255) NULL, \`note\` varchar(255) NULL, \`accountId\` int NOT NULL, \`voucherId\` int NULL, \`createdAt\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
