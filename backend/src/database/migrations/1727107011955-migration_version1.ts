...
export class Version11727107011955 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE \`like\` (\`id\` int NOT NULL AUTO_INCREMENT, \`accountId\` int NOT NULL, \`itemId\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
            `CREATE TABLE \`review\` (\`id\` int NOT NULL AUTO_INCREMENT, \`rating\` int NOT NULL, \`comment\` varchar(255) NOT NULL, \`itemId\` int NOT NULL, \`accountId\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
            `CREATE TABLE \`item\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name_vi\` varchar(255) NOT NULL, \`name_en\` varchar(255) NOT NULL, \`discount\` int NOT NULL DEFAULT '0', \`carbohydrates\` int NOT NULL, \`protein\` int NOT NULL, \`cholesterol\` int NOT NULL, \`sodium\` int NOT NULL, \`fiber\` int NOT NULL, \`description_vi\` varchar(255) NOT NULL, \`description_en\` varchar(255) NOT NULL, \`availability\` varchar(255) NOT NULL DEFAULT 'in stock', \`rating\` float NOT NULL DEFAULT '5', \`ingredients_vi\` varchar(255) NOT NULL DEFAULT '[]', \`ingredients_en\` varchar(255) NOT NULL DEFAULT '[]', \`unit_vi\` varchar(255) NOT NULL, \`unit_en\` varchar(255) NOT NULL, \`images\` varchar(255) NOT NULL DEFAULT '[]', \`regional_vi\` varchar(255) NOT NULL, \`regional_en\` varchar(255) NOT NULL, \`isFood\` tinyint NOT NULL DEFAULT 1, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`categoryId\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
            `CREATE TABLE \`voucher\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name_vi\` varchar(255) NOT NULL, \`name_en\` varchar(255) NOT NULL, \`discount\` int NOT NULL, \`minPrice\` int NOT NULL, \`startAt\` datetime NOT NULL, \`endAt\` datetime NOT NULL, \`count\` int NOT NULL DEFAULT '0', \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
            `CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`totalPrice\` int NOT NULL, \`phoneNumber\` varchar(10) NOT NULL, \`receiver\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`paymentMethod\` varchar(255) NOT NULL DEFAULT 'cash', \`status\` varchar(255) NOT NULL DEFAULT 'wait', \`reasonCancel\` varchar(255) NOT NULL, \`note\` varchar(255) NOT NULL, \`accountId\` int NOT NULL, \`voucherId\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE \`cart\` (\`id\` int NOT NULL AUTO_INCREMENT, \`quantity\` int NOT NULL, \`accountId\` int NOT NULL, \`itemSizeId\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
            `CREATE TABLE \`account\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`displayName\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`tel\` varchar(10) NOT NULL, \`avatar\` varchar(255) NOT NULL DEFAULT 'https://res.cloudinary.com/deei5izfg/image/upload/f_auto,q_auto/v1/VietnameseFoodRestaurant/skohr4qgffuyanefqy91', \`gender\` varchar(255) NOT NULL DEFAULT 'male', \`password\` varchar(255) NOT NULL, \`role\` varchar(255) NOT NULL DEFAULT 'customer', \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
        await queryRunner.query(
